...
const testimonials = [
  { stars: 5, highlight: "Game-changer for my business", text: "PropReel has completely transformed how I market properties. I went from spending hours on video editing to creating stunning reels in minutes.", name: "Johan Smit", role: "Principal Agent", company: "Smit Properties", city: "Sandton" },
  ...
  { stars: 5, highlight: "Worth every cent", text: "The quality of the videos is incredible. My listings get significantly more enquiries since I started using PropReel.", name: "Willem van der Berg", role: "Solo Agent", company: "Seeff", city: "Stellenbosch" },
            ...
            <div key={i} className="bg-white border border-gray-100 rounded-2xl p-6 hover:shadow-lg transition-all">
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center">
                  <span className="text-sm font-bold text-purple-700">{t.name.split(" ").map(n => n[0]).join("")}</span>
                </div>
                <div>
