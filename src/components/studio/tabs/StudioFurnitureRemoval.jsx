...
export default function StudioFurnitureRemoval({ photos, onPhotoReplaced }) {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
          <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide px-4 pt-3 pb-2">Before</p>
          <div className="aspect-video"><img src={originalPhoto} alt="" className="w-full h-full object-cover" /></div>
        </div>
        <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
          <p className="text-xs font-semibold text-purple-700 uppercase tracking-wide px-4 pt-3 pb-2">After Removal</p>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-5">
        ...
        <Button
          onClick={runRemoval}
          disabled={processing || !selectedMode || (selectedMode === "custom" && !customPrompt.trim())}
