...
const command = makeBuilder(commonParams, "Parrot_v1", "PollyClient", getEndpointPlugin);
const _ep0 = {};
...
class DeleteLexiconCommand extends command(_ep0, _mw0, "DeleteLexicon", DeleteLexicon$) {
}

class DescribeVoicesCommand extends command(_ep0, _mw0, "DescribeVoices", DescribeVoices$) {
}

class GetLexiconCommand extends command(_ep0, _mw0, "GetLexicon", GetLexicon$) {
}

class GetSpeechSynthesisTaskCommand extends command(_ep0, _mw0, "GetSpeechSynthesisTask", GetSpeechSynthesisTask$) {
}

class ListLexiconsCommand extends command(_ep0, _mw0, "ListLexicons", ListLexicons$) {
}

class ListSpeechSynthesisTasksCommand extends command(_ep0, _mw0, "ListSpeechSynthesisTasks", ListSpeechSynthesisTasks$) {
}

class PutLexiconCommand extends command(_ep0, _mw0, "PutLexicon", PutLexicon$) {
}

class StartSpeechSynthesisStreamCommand extends command(_ep0, _mw1, "StartSpeechSynthesisStream", StartSpeechSynthesisStream$) {
}

class StartSpeechSynthesisTaskCommand extends command(_ep0, _mw0, "StartSpeechSynthesisTask", StartSpeechSynthesisTask$) {
}

class SynthesizeSpeechCommand extends command(_ep0, _mw0, "SynthesizeSpeech", SynthesizeSpeech$) {
}
